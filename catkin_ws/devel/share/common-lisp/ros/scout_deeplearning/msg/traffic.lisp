...
(cl:defmethod cl:initialize-instance :after ((m <traffic>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'traffic)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scout_deeplearning-msg:<traffic> is deprecated: use scout_deeplearning-msg:traffic instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <traffic>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_deeplearning-msg:name-val is deprecated.  Use scout_deeplearning-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <traffic>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_deeplearning-msg:number-val is deprecated.  Use scout_deeplearning-msg:number instead.")
  (number m))
