...
(cl:defmethod cl:initialize-instance :after ((m <identify>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'identify)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scout_deeplearning-msg:<identify> is deprecated: use scout_deeplearning-msg:identify instead.")))

(cl:ensure-generic-function 'results-val :lambda-list '(m))
(cl:defmethod results-val ((m <identify>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_deeplearning-msg:results-val is deprecated.  Use scout_deeplearning-msg:results instead.")
  (results m))

(cl:ensure-generic-function 'classes-val :lambda-list '(m))
(cl:defmethod classes-val ((m <identify>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_deeplearning-msg:classes-val is deprecated.  Use scout_deeplearning-msg:classes instead.")
  (classes m))

(cl:ensure-generic-function 'area-val :lambda-list '(m))
(cl:defmethod area-val ((m <identify>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_deeplearning-msg:area-val is deprecated.  Use scout_deeplearning-msg:area instead.")
  (area m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <identify>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_deeplearning-msg:position-val is deprecated.  Use scout_deeplearning-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'acc-val :lambda-list '(m))
(cl:defmethod acc-val ((m <identify>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_deeplearning-msg:acc-val is deprecated.  Use scout_deeplearning-msg:acc instead.")
  (acc m))

(cl:ensure-generic-function 'image_number-val :lambda-list '(m))
(cl:defmethod image_number-val ((m <identify>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_deeplearning-msg:image_number-val is deprecated.  Use scout_deeplearning-msg:image_number instead.")
  (image_number m))
