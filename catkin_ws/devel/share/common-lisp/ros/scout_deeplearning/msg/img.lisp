...
(cl:defmethod cl:initialize-instance :after ((m <img>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'img)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scout_deeplearning-msg:<img> is deprecated: use scout_deeplearning-msg:img instead.")))

(cl:ensure-generic-function 'img-val :lambda-list '(m))
(cl:defmethod img-val ((m <img>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_deeplearning-msg:img-val is deprecated.  Use scout_deeplearning-msg:img instead.")
  (img m))
