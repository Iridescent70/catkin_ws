...
(cl:defmethod cl:initialize-instance :after ((m <light>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'light)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name scout_deeplearning-msg:<light> is deprecated: use scout_deeplearning-msg:light instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <light>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader scout_deeplearning-msg:mode-val is deprecated.  Use scout_deeplearning-msg:mode instead.")
  (mode m))
